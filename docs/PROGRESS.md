...
> 供后续开发（含 AI agent）继续工作参考。最后更新：2026-09-01（代码审计报告 P0/P1 修复批：全局 ErrorBoundary + parseClient 超时/terminate + Dexie 多标签升级 + 存储配额分类 + 赛段页 N+1 修复 + 跨月测试断言修复 + 爬升口径 + 训练指标校准 + 重复代码收敛，版本 2.28.2 → 2.29.0）。
>
