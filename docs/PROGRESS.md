...
> 供后续开发（含 AI agent）继续工作参考。最后更新：2026-09-04（审计修复复查批：calculateSummary 单遍聚合 + db.ts 死事件清理/versionchange 放行 + parseClient 注释修正，版本 2.29.0 → 2.29.1；另入库 docs/代码审计报告-2026-09-01.md）。
>
