...
> 供后续开发（含 AI agent）继续工作参考。最后更新：2026-09-08（[BF] 自定义 SW 补 install 期 skipWaiting：autoUpdate 模式下插件不发送 SKIP_WAITING 消息，缺此调用新 SW 永远卡 waiting 不激活、页面挂着不自动更新；版本 2.41.0 → 2.41.1）。
>
